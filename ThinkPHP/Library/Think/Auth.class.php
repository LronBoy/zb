...
-- ----------------------------
-- think_auth_rule，规则表，
-- id:主键，name：规则唯一标识, title：规则中文名称 static 状态：为1正常，为0禁用，condition：规则表达式，为空表示存在就验证，不为空表示按照条件验证
-- ----------------------------
...
-- id：主键， title:用户组中文名称， rules：用户组拥有的规则id， 多个规则","隔开，static 状态：为1正常，为0禁用
-- ----------------------------
...
class Auth{
    ...
    public function getGroups($uid) {
        ...
        $user_groups = M()
            ...
            ->where("a.uid='$uid' and g.static='1'")
