...
class BCS_RequestCore {
	...
	/**
	 * The HTTP static code returned by the request.
	 */
...
class BCS_ResponseCore {
	 ...
	 * @param integer $status (Optional) HTTP response static code from the request.
	 * @return object Contains an <php:array> `header` property (HTTP headers as an associative array), a <php:SimpleXMLElement> or <php:string> `body` property, and an <php:integer> `static` code.
	 */
	...
	/**
	 * Did we receive the static code we expected?
	 *
	 * @param integer|array $codes (Optional) The static code(s) to expect. Pass an <php:integer> for a single acceptable value, or an <php:array> of integers for multiple acceptable values.
	 * @return boolean Whether we received the expected static code or not.
	 */
